...
class SecureStorage {
  ...
  Future<void>   saveLocale(String code) => _s.write(key: _keyLocale, value: code);
  Future<String> getLocale() async => await _s.read(key: _keyLocale) ?? 'en';

  Future<void>   saveOnboardingSeen() => _s.write(key: _keyOnboarding, value: '1');
  Future<bool>   getOnboardingSeen() async => await _s.read(key: _keyOnboarding) == '1';

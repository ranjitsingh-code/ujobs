class Ep {
  ...
  static const verifyOtp       = '/auth/verify-otp'; // ⚠️ returns 500 — handle gracefully
  ...
  static String applicants(String jobId) => '/employer/jobs/$jobId/applicants'; // ⚠️ no global /employer/applications (404)
  static String application(String id)   => '/employer/applications/$id';
  static String empCompany(String id)    => '/employer/company/$id'; // PUT only — GET from /employer/me
  ...
  static const empSavedCandidates = '/employer/saved-candidates'; // ⚠️ returns 500
  ...
  static const seekerResumes     = '/seeker/resumes';   // multipart/form-data — NOT JSON
  ...
  static String screeningQs(String id)   => '/public/jobs/$id/screening-questions';

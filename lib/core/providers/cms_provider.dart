...
final cmsPagesListProvider = FutureProvider.autoDispose<List<CmsPage>>((ref) async {
...
final cmsPageDetailProvider = FutureProvider.autoDispose.family<CmsPage, String>((ref, slug) async {
  final dio = ref.watch(dioClientProvider).dio;

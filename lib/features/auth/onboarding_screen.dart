...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen>
  ...
  void initState() {
    ...
    _entrySlide = Tween(begin: const Offset(0, 0.06), end: Offset.zero).animate(CurvedAnimation(parent: _entryCtrl, curve: Curves.easeOut));
  }
  ...
  void _next(int slideCount) {
    if (_page < slideCount - 1) {
      _pageCtrl.nextPage(duration: const Duration(milliseconds: 380), curve: Curves.easeInOutCubic);
    } else {
      _markSeenAndGo();
    }
  }
          ...
          child: SlideTransition(
            ...
            child: Column(children: [
                  ...
                  Row(
                    children: List.generate(slides.length, (i) => AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: i == _page ? slides[_page].accent : AppColors.border,
              ...
              Padding(
                ...
                child: UJobButton(
                  label: _page < slides.length - 1 ? l10n.continueButton : l10n.getStarted,
                  onTap: () => _next(slides.length),
                  color: slides[_page].accent,
                  gradient: LinearGradient(
                    colors: [slides[_page].accent.withValues(alpha: 0.85), slides[_page].accent],
...
class _SlideViewState extends State<_SlideView> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slide = Tween(begin: const Offset(0, 0.08), end: Offset.zero).animate(CurvedAnimation(parent: _ctrl, curve: Curves.easeOut));
  }
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(
                child: Container(
                  ...
                  child: _IllustrationWidget(type: widget.slide.illustrationType, accent: widget.slide.accent),
                ),
              ),
              SizedBox(height: 28.h),
              Text(widget.slide.title, style: AppText.heading1.copyWith(letterSpacing: -0.8, height: 1.15)),
              SizedBox(height: 10.h),
              Text(widget.slide.sub, style: AppText.body.copyWith(color: AppColors.muted)),
  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          Container(
            ...
            child: Row(children: [
              SizedBox(width: 14.w),
              HugeIcon(icon: HugeIcons.strokeRoundedSearch01, color: accent, size: 18.r),
              SizedBox(width: 10.w),
              Expanded(child: Container(height: 10.h, decoration: BoxDecoration(color: AppColors.border, borderRadius: AppRadius.pill))),
              SizedBox(width: 14.w),
            ]),
          ),
      ...
      return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Center(child: Text(letter, style: AppText.bodyBold.copyWith(color: AppColors.surface))),
          ),
          SizedBox(width: 10.w),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(height: 9.h, width: 100.w, decoration: BoxDecoration(color: AppColors.text2.withValues(alpha: 0.7), borderRadius: AppRadius.pill)),
            SizedBox(height: 5.h),
            Container(height: 7.h, width: 70.w, decoration: BoxDecoration(color: AppColors.muted2, borderRadius: AppRadius.pill)),
          ])),
          Container(
            padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 3.h),
            decoration: BoxDecoration(color: accent.withValues(alpha: 0.1), borderRadius: AppRadius.pill),
            child: Text(count.split(' ')[0], style: AppText.labelSm.copyWith(color: accent)),
          ),
        ]),
      );
    }).toList();
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: accent.withValues(alpha: 0.12), borderRadius: AppRadius.pill),
                  child: Text('+ Post Job', style: AppText.label.copyWith(color: accent)),
                ),
                SizedBox(width: 8.w),
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 4.h),
                  decoration: BoxDecoration(color: AppColors.border, borderRadius: AppRadius.pill),
                  child: Text('Applicants', style: AppText.label.copyWith(color: AppColors.text2)),
                ),
              ]),
              SizedBox(height: 14.h),
              Text('Recent Applicants', style: AppText.small.copyWith(fontWeight: FontWeight.w700)),
              SizedBox(height: 10.h),
              Row(children: ['SC', 'AH', 'MG', 'JK'].asMap().entries.map((e) {
                const colors = [AppColors.primary, AppColors.purple, AppColors.success, AppColors.warning];
                return Transform.translate(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text(e.value, style: AppText.labelSm.copyWith(color: AppColors.surface))),
                  ),
                );
              }).toList()),
            ]),
  ...
  Widget build(BuildContext context) => Expanded(
        child: Container(
          ...
          child: Column(children: [
            ...
            Text(label, style: AppText.overline.copyWith(color: AppColors.muted, height: 1.3), textAlign: TextAlign.center),
          ]),
        ),
      );
}
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Container(
                  ...
                  child: HugeIcon(icon: HugeIcons.strokeRoundedSparkles, size: 16.r, color: accent),
                ),
                SizedBox(width: 8.w),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('AI Match Score', style: AppText.labelSm.copyWith(color: AppColors.muted)),
                  Text('98% Compatible', style: AppText.small.copyWith(fontWeight: FontWeight.w700, color: accent)),
                ]),
                const Spacer(),
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 3.h),
                  decoration: BoxDecoration(color: accent.withValues(alpha: 0.10), borderRadius: AppRadius.pill),
                  child: Text('Live', style: AppText.overline.copyWith(color: accent, fontWeight: FontWeight.w700)),
                ),
              ]),
              SizedBox(height: 10.h),
              ClipRRect(
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Salary Insights', style: AppText.small.copyWith(fontWeight: FontWeight.w700)),
                Text('+18% avg', style: AppText.labelSm.copyWith(color: AppColors.success, fontWeight: FontWeight.w600)),
              ]),
              SizedBox(height: 10.h),
              SizedBox(
                height: 36.h,
                  ...
                  children: _salaryBars.asMap().entries.map((e) {
                    ...
                    return Expanded(
                      child: Container(
                        ...
                        height: 36.h * e.value,
                        decoration: BoxDecoration(
                          color: isLast ? accent : accent.withValues(alpha: 0.25 + e.key * 0.08),
...
class _Tag extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Text(label, style: AppText.overline.copyWith(color: accent, fontWeight: FontWeight.w600)),
      );
}

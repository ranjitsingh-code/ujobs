  ...
  DemoEmployerJobsNotifier()
    : super([
        Job(
          ...
          description:
              '[{"insert":"We are looking for a skilled Software Engineer to join our dynamic team. You will be responsible for building high-performance, scalable applications. Your daily tasks will include writing clean, maintainable code, reviewing pull requests, and collaborating with cross-functional teams.\\n"}]',
          ...
          screeningQuestions: [
            {
              'text': 'Do you have 3+ years of experience in Flutter?',
              'is_required': true,
            },
            {
              'text':
        ...
        Job(
          ...
          description:
              '[{"insert":"Looking for an experienced Website Developer to design, build, and maintain our company websites. You should be proficient in modern web frameworks and have a strong eye for UI/UX design. You will work closely with the marketing team to ensure optimal website performance and SEO.\\n"}]',
          category: 'Engineering',
          employmentType: 'Full-Time',
          ...
          screeningQuestions: [
            {
              'text': 'Can you share a link to your portfolio?',
              'is_required': true,
            },
          ],
        ),
        Job(
          ...
          description:
              '[{"insert":"Seeking a Mobile Application Developer with Flutter experience to build and maintain both iOS and Android applications. You will be an integral part of our core product team, ensuring that our mobile applications are robust, performant, and user-friendly.\\n"}]',
          category: 'Engineering',
        ...
        Job(
          ...
          title: 'SEO Expert',
          description:
              '[{"insert":"We need an SEO Expert to boost our organic reach and drive massive traffic to our main platforms. You will be conducting keyword research, competitive analysis, and executing full-scale SEO strategies.\\n"}]',
          category: 'Marketing',
          employmentType: 'Full-Time',
          workplaceType: 'Remote',
          location: 'Remote',
          ...
          screeningQuestions: [
            {
              'text': 'What is your most successful SEO campaign to date?',
              'is_required': true,
            },
          ],
        ),
        Job(
          ...
          title: 'Data Analyst',
          description:
              '[{"insert":"Join our data team as a Data Analyst. You will be responsible for interpreting data, analyzing results, and providing ongoing reports. You will work closely with management to prioritize business and information needs.\\n"}]',
        ...
        Job(
          ...
          description:
              '[{"insert":"Protect our infrastructure as a Cybersecurity Expert. You will be analyzing security logs, identifying vulnerabilities, and implementing robust security measures across all our cloud environments.\\n"}]',
          category: 'Security',
          employmentType: 'Full-Time',
          workplaceType: 'Hybrid',
        ...
        Job(
          ...
          description:
              '[{"insert":"Looking for a versatile Digital Marketer to oversee our online marketing strategy. You will be managing social media campaigns, email marketing, and paid advertising.\\n"}]',
          category: 'Marketing',

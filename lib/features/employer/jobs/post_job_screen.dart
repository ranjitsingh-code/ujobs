...
class _PostJobScreenState extends ConsumerState<PostJobScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ref.read(demoEmployerJobsProvider.notifier).addFromForm(data);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            UJobTextField(
              label: l10n.jobTitle,
              hint: l10n.jobTitleJobHint,
              controller: _titleCtrl,
            ),
            const SizedBox(height: 16),
            UJobTextField(
              label: l10n.jobDescription,
            ...
            Row(
              children: [
                Expanded(
                  child: UJobTextField(
                    label: l10n.salaryMin,
                    hint: l10n.salaryMinHint,
                ...
                Expanded(
                  child: UJobTextField(
                    label: l10n.salaryMax,
                    hint: l10n.salaryMaxHint,

...
final _companyProvider = StateProvider<_Company>((ref) {
  return const _Company(
    id: 'demo-company',
    name: 'Nexovia Technologies',
    industry: 'Technology',
    size: '51-200 employees',
    website: 'https://nexovia.example',
    location: 'Dhaka, Bangladesh',
    description:
        'We build practical digital products that make work simpler and more accessible.',
    activeJobs: 2,
    applicants: 124,
  );
});
...
class CompanyProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: _CompanyBody(company: company),
    );
  }
}
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              _StatBox(
                value: company.activeJobs?.toString() ?? '—',
                label: 'Active Jobs',
              ),
              const SizedBox(width: 12),
              _StatBox(
                value: company.applicants?.toString() ?? '—',
                label: 'Applicants',
              ),
              const SizedBox(width: 12),
        ...
        _CompanySection(
          title: 'About Company',
          subtitle: company.description?.isNotEmpty == true
              ? company.description!
          ...
          child: Column(
            ...
            children: [
              ...
              UJobButton(
                label: 'Save Changes',
                onTap: () {
                  ref.read(_companyProvider.notifier).state = _Company(
                    id: company.id,
                    name: nameCtrl.text,
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: const BoxDecoration(
      gradient: LinearGradient(
        colors: [
          AppColors.empPrimaryDark,
          AppColors.empPrimary,
          AppColors.empSecondary,
        ],
    ...
    child: Container(
      ...
      child: Column(
        children: [
          Text(
            value,
            style: AppText.heading3.copyWith(color: AppColors.empPrimary),
          ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text(
              context.l10n.edit,
              style: AppText.label.copyWith(color: AppColors.empPrimary),
            ),

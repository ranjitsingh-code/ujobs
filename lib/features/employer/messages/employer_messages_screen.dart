...
class EmployerMessagesScreen extends ConsumerStatefulWidget {
  const EmployerMessagesScreen({super.key});

  @override
  ConsumerState<EmployerMessagesScreen> createState() => _EmpMessagesState();
}

class _EmpMessagesState extends ConsumerState<EmployerMessagesScreen> {
            ...
            data: (convs) {
              ...
              if (list.isEmpty) {
                return const UJobEmpty(
                  ...
                  subtitle: 'Start a conversation with a candidate',
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              if (conv.unreadCount > 0)
                Container(
                  width: 20,
                  height: 20,
                  decoration: const BoxDecoration(color: AppColors.empPrimary, shape: BoxShape.circle),
                  child: Center(
                    child: Text(

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        _NavTile(label: l10n.editCompanyProfile, onTap: () => context.push('/employer/profile')),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          UJobTextField(label: l10n.currentPassword, controller: oldCtrl, isPassword: true),
          UJobTextField(label: l10n.newPassword, controller: newCtrl, isPassword: true),
          UJobTextField(label: l10n.confirmNewPassword, controller: confirmCtrl, isPassword: true),
          UJobButton(
            label: l10n.updatePassword,
            onTap: () async {
              try {
                await ref.read(dioClientProvider).dio.put(Ep.empPassword, data: {
...
class _ToggleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: [
          ...
          Switch(value: value, onChanged: onChanged, activeThumbColor: AppColors.empPrimary, activeTrackColor: AppColors.empPrimary.withValues(alpha: 0.5)),
        ]),
      );
}
